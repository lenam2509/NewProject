        ...
        <div className='bg-[#f0f2f5] w-[50%] h-full m-auto'>
            ...
            <div className='bg-[#fff] w-[90%] h-[100px] flex ml-[5%] mt-3 rounded-sm'>
              <div className="w-[80px] h-[80px] ml-[5%] my-[10px]">
                <a href="#">
                  <Image src={aothun1} width='80' height='80' />
                </a>
              </div>
              ...
              <div className="w-[180px] h-[80px] my-[10px] flex flex-col justify-center">
                <div className="ml-[25%] flex flex-row">
                  <button className="w-6 border-gray-400 border-[1px] rounded-sm h-6 cursor-pointer" value='-'>-</button>
                  <input type="tel" value={2} readOnly className='w-[50px] h-6 text-center bg-transparent border-gray-400 border-[1px] outline-none' />
                  <button className="w-6 border-gray-400 border-[1px] rounded-sm h-6 cursor-pointer" value='+'>+</button>
                </div>
              </div>
            ...
            <button className="mb-[15px] ml-[76%] bg-yellow-300 w-auto h-auto px-10 py-2 rounded-sm hover:bg-yellow-500">Thanh toán (1)</button>
        </div>
    </div>
  )
}
